...
const deatilslice = createSlice({
  ...
  reducers: {
    changeitemobj(state, { payload }) {
      state.itemobj = payload
    },
  },
})

export const { changeitemobj } = deatilslice.actions

export const deatilreducer = deatilslice.reducer
